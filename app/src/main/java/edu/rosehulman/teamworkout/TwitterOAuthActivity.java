...
/**
 * Created by lashomjt on 2/1/2016.
 */
public class TwitterOAuthActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTwitter = new TwitterFactory(new ConfigurationBuilder()
                .setOAuthConsumerKey(getResources().getString(R.string.twitter_key))
                .setOAuthConsumerSecret(getResources().getString(R.string.twitter_secret))
                .build()).getInstance();
